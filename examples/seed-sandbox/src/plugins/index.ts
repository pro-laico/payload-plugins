...
// `assets` defaults to dir `assets` + collection `media`, so it's omitted here.
export const seedDefinitions = [assetsSeed, servicesSeed, postsSeed, siteSettingsSeed]

export const plugins: Plugin[] = [seedPlugin({ definitions: seedDefinitions, adminButton: true })]
