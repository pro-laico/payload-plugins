...
// is just `defineSeed('icon', …)` with each SVG on its `_file` meta-key; the engine
// uploads each from `seed-assets/icon/` through the normal flow (running the optimize hook), and a
