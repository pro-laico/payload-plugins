 ...
 *  Files live in `seed-assets/image/`.
 *
...
export default defineCollectionSeed('images', ({ file }) => [
  { _key: 'lighthouse', _file: file('lighthouse.png'), alt: 'Landscape sample', focalX: 78, focalY: 32 },
  { _key: 'balloon', _file: file('balloon.png'), alt: 'Portrait sample', focalX: 50, focalY: 22 },
