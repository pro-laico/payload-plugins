...
**The optimized images revalidate themselves, with nothing to configure.** Every transform URL is immutable and
...
[`@pro-laico/payload-seed`](/docs/plugins/payload-seed)'s normal `asset()` flow, with no special
