...
<TypeTable
  type={{
    ...
    placeholder: { description: "A finished data URI focal-cropped to the declared render. Defaults to the sm tier; a blur request (context.blur / X-Blurhash header) picks its own tier, and context: { blur: false } opts the read out (null).", type: "virtual" },
