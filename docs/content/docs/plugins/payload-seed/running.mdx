...
export const runNodes = [
  ...
  { id: 'clear', label: 'Clear the seeded collections', detail: 'destructive — delete hooks fire so external assets clean up; queued Payload Jobs are cleared too (stale after a reseed)', x: 300, y: 520 },
