...
The extension is forgiving for images: `file('hero.jpg')` also matches a `hero.webp`, `hero.png`,
`hero.avif`, `hero.gif`, `hero.svg`, or `hero.jpeg` sitting in that folder — re-encode an asset without
editing the seed.
