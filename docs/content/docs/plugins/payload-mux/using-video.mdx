...
Turn signed playback on with the `playbackPolicy: 'signed'` plugin option — see [Quickstart](/docs/plugins/payload-mux#quickstart) and [Plugin options](/docs/plugins/payload-mux/reference#plugin-options).
