...
[`@pro-laico/payload-seed`](/docs/plugins/payload-seed#external-asset-collections) like any image — no
...
[seed plugin docs](/docs/plugins/payload-seed#external-asset-collections) for the full reference.
