...
<Callout type="info">
  Driving the selection some other way? Pass `includeFontSet: false` to skip the global and resolve
  the active typefaces yourself. Without it, the export endpoint has nothing to resolve.
</Callout>
...
(see [`DevFonts` props](/docs/plugins/payload-fonts/serving#devfonts-props)).
...
- [Serving](/docs/plugins/payload-fonts/serving) — the production and development paths, `DevFonts` props, and env vars.
