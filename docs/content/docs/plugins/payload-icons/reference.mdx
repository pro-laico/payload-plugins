...
export const options = [
  ...
  { name: 'options', type: 'IconsOptions', default: '{}', description: `The plugin's own knobs.`, options: [
    { name: 'access', type: 'IconsAccessOptions', description: `Per-endpoint gates for the plugin's HTTP endpoints — one EndpointAccess ((req) => boolean | Promise<boolean>) per endpoint. See Gating endpoints.`, options: [
      { name: 'clearRequests', type: 'EndpointAccess', default: 'any logged-in user', description: `Gates DELETE /payload-icons/icon-requests (the usage panel's Clear button). Only registered while the iconRequest collection is on.` },
    ] },
  ] },
]
