...
<Cards>
  ...
  <Card
    ...
    description="Dev-only tooling — /dev pages inside your app (seed controls, icon/font/image labs, a component test harness), a floating dev toolbar, and a machine-readable app snapshot for AI agents."
  />
</Cards>
