...
runs all five plugins on one fictional studio site, and each plugin has a focused sandbox
(`seed-sandbox`, `images-sandbox`, `icons-sandbox`, `fonts-sandbox`, `mux-sandbox`).
